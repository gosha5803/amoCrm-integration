...
//Добавил интерцептор на ошибку 401, для запроса нового access токена с api, и один интерцептор на переиспользуемую логику с заголовком авторизации и токеном. Далее все запросы к api, осуществляются, через этот сервис.
